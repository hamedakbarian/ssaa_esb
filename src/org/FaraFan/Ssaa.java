...
//              String responceDataFromFile=new String (Files.readAllBytes(Paths.get("D:\\Farafan\\SSAA\\XML2\\" + count +".txt")),"UTF-8");
//              System.out.println(responceDataFromFile);
             response response = Utils.parse_xml_to_object(responseData);
